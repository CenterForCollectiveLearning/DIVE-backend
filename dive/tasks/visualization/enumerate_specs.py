...
def enumerate_viz_specs(project_id, dataset_id, selected_fields):
    ...
    if selected_fields:
        ...
        cascading_viz_specs = get_cascading_viz_specs(n_c, n_q, c_fields, q_fields)
        specs.extend(cascading_viz_specs)

        expanded_viz_specs = get_expanded_viz_specs(n_c, n_q, c_fields, q_fields)
        specs.extend(expanding_viz_specs)
    else:
...
def get_cascading_viz_specs(n_c, n_q, c_fields, q_fields):
    '''
...
def get_expanded_viz_specs(n_c, n_q, c_fields, q_fields):
    '''
