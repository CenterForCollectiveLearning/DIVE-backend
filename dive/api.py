...
from dive.resources.statistics_resources import CorrelationsFromSpec, RegressionEstimator, RegressionFromSpec, SummaryStatsFromSpec, NumericalComparisonFromSpec, OneDimensionalTableFromSpec, ContingencyTableFromSpec, ComparisonFromSpec, SegmentationFromSpec, ContributionToRSquared
